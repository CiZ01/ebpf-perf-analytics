...
#include "vmlinux.h"
#include "../xdp_sample/xdp_sample.bpf.h"
#include "../xdp_sample/xdp_sample_shared.h"

// MY CODE
#include "/usr/local/include/mykperf/mykperf_module.h"
    ...
    case ETH_P_IP: {
        ...
        else
        {
            ...
            if (!dest_mac)
            {
                ...
                dest_mac = bpf_map_lookup_elem(&arp_table, &prefix_value->gw);
                if (!dest_mac)
                {

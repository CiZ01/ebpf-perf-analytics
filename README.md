...
> [!CAUTION] This command will reset the event counter and the PMC registers. This will disable the monitoring of the events. Be sure to set the right PMC register in the file
```bash
sudo ./clean_reg.sh -1
```